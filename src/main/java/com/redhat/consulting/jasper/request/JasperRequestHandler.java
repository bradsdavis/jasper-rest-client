...
public class JasperRequestHandler {
	private static final Logger LOG = org.slf4j.LoggerFactory.getLogger(JasperRequestHandler.class);
	...
	public JasperRequestHandler(HttpClient httpClient, String baseUri, JasperRequestContext context) {
